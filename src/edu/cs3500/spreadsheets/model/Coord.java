...
/**
 * A value type representing coordinates in a {@link WorksheetBasic}.
 */
public class Coord {
  ...
  /**
   * Constructor that sets a Coord based on inputted column and row of the coordinate.
   *
   * @param col the column of this coord
