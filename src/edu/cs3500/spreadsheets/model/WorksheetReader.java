...
public final class WorksheetReader {
  ...
  public interface WorksheetWithGraphBuilder<T> extends WorksheetBuilder<T> {

    /**
     * Creates a new graph with the specified type, name, and region of coordinates based on a
     * starting and ending coordinate.
     *
     * @param type  the type of the graph
     * @param title  the name of the graph
     * @param start the starting coordinate of the graph
     * @param end   the ending coordinate of the graph
     * @return this
     */
    WorksheetWithGraphBuilder<T> insertGraph(String type, String title, Coord start, Coord end);
  }
